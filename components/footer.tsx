...
export function Footer() {
  ...
  return (
    <footer className="px-6 py-12 border-t border-border" role="contentinfo">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <nav className="flex items-center gap-6" aria-label={t('accessibility.footerNavigation')}>
            ...
            <a
              href="https://github.com/allegoryjs/allegoryjs/discussions"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/allegoryjs/allegoryjs/issues"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-muted-foreground hover:text-primary transition-colors"
            >
