...
export function GitHubCommits() {
  ...
  return (
    <section className="px-6 py-16 md:py-24" aria-labelledby="commits-heading">
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-12">
          ...
          <h2 id="commits-heading" className="text-3xl md:text-4xl font-serif mb-4 text-foreground">
